    ...
    <v-card-text>
      <v-form ref="form">
        <v-row dense align="center" class="ma-4">
          <v-col cols="12">
            <v-select v-model="source" dark :items="items" label="Fuente" outlined return-object item-text="name" hide-details rounded>
        ...
        <v-expand-transition>
          <v-row v-show="twitterUser.id" class="pt-4" dense>
